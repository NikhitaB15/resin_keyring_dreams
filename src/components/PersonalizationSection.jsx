            ...
            <div className="container" style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                    ...
                    <p style={{
                        ...
                        Carry your cherished memories wherever you go or display them beautifully at home! We create custom resin keyrings and photo frames magically preserved with your favorite memories.
                    </p>
                </div>
                ...
                <div style={{ 
                    height: '2px', 
                    background: 'linear-gradient(90deg, transparent, rgba(246, 193, 204, 0.5), transparent)', 
                    margin: '3rem 0 4rem 0' 
                }} />

                {/* Photo Frame - Two Column Layout (Reversed) */}
                <div style={{
                    display: 'grid',
                    gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 450px), 1fr))',
                    gap: '3rem',
                    ...
                    {/* Content Side */}
                    <div style={{ animation: 'fadeIn 1s ease-out 0.4s backwards', direction: 'ltr' }}>
                        <h3 style={{
                            fontFamily: 'var(--font-accent)',
                            fontSize: 'clamp(1.8rem, 4vw, 2.5rem)',
                            color: 'var(--text-dark)',
                            ...
                            {[
                                {
                                    ...
                                    desc: 'Choose from different elegant frame shapes designed just for you'
                                },
                                {
                                    icon: '💐',
                                    title: 'Floral Additions',
                                    desc: 'Enhance your customized frame with beautiful preserved flowers'
                                },
                                {
                                    icon: '✨',
                                    title: 'Premium Finish',
                                    desc: 'High-quality resin ensures a glossy, scratch-resistant surface'
                                }
                            ].map((feature, idx) => (
                                <div key={idx} style={{
                                    display: 'flex',
                        ...
                        {/* Pricing Card */}
                        <div style={{
                            background: 'linear-gradient(135deg, rgba(201, 162, 77, 0.1), rgba(246, 193, 204, 0.15))',
                            ...
                            <p style={{
                                ...
                                Perfect for saving memories or gifting special ones
                            </p>
                        </div>
                    </div>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <img
                                src="/products/photo_frame_personalized.jpg"
                                alt="Personalised Resin Photo Frame"
                                style={{
                                    width: '100%',
                                    height: 'auto',
                                    borderRadius: '12px',
                                ...
                                onError={(e) => {
                                    e.target.style.background = 'linear-gradient(135deg, rgba(201, 162, 77, 0.3), rgba(246, 193, 204, 0.2))';
                                    e.target.style.height = '400px';
                                    e.target.style.display = 'flex';
                                    e.target.style.alignItems = 'center';
                                    e.target.style.justifyContent = 'center';
                                    e.target.alt = '🖼️ Custom Photo Frame';
                                }}
                            />
                        </div>
                        ...
                        <div style={{
                            ...
                            top: '-15px',
                            left: '-15px',
                            background: 'linear-gradient(135deg, var(--accent), #e3c472)',
                            color: 'white',
                            padding: '1rem 1.5rem',
                            borderRadius: '50px',
                            fontWeight: 'bold',
                            fontSize: '1.1rem',
                            boxShadow: '0 10px 30px rgba(201, 162, 77, 0.4)',
                            animation: 'pulse 2s ease-in-out infinite',
                            display: 'flex',
                            alignItems: 'center',
                            gap: '0.5rem',
                            ...
                            <Sparkles size={20} fill="white" /> ₹860
                        </div>
                    </div>
                </div>
